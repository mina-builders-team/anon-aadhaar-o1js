...
console.log(
  `keyPairs${ver}.json is saved. Fund them before using them in CounterZkapp creation.`
)
...
const pendingTransaction = await deployTx
  .sign([zkAppPrivateKey, privateKey])
  .send()
