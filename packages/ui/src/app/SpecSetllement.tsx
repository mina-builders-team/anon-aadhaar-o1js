  ...
  return (
    <div className="flex flex-col items-center gap-6 p-6 max-w-2xl mx-auto">
      <button
        ...
        disabled={!provider || !proofJson || isLoading}
      ...
      {txResult && (
        <div className="p-4 bg-green-900/20 border border-green-700 rounded-lg w-full">
          <h3 className="text-green-300 font-semibold mb-2">Transaction Submitted!</h3>
          <div className="space-y-2">
            <div className="break-all">
              <span className="text-gray-400 text-sm">Hash:</span>
              <p className="text-white font-mono text-sm">{txResult.hash || txResult.txId}</p>
            </div>
            {(txResult.hash || txResult.txId) && (
              ...
              >
                View on Explorer - Upon included tx, you can refresh and see the counter is incremented!
